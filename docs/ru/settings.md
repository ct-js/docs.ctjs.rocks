...
Булево свойство, которое указывает, запущена ли игра в режиме отладки (т.е. внутри дебаггера ct.js). Это свойство нельзя поменять вручную во время игры, но во время тестирования её можно переопределить в настройках ct.js через опцию "Включить релизные функции для дебаг-экспортов".

## settings.isProduction

Булево свойство, которое указывает, запущена ли игра в режиме производства — напр. в браузере или как приложение для ПК. Это свойство нельзя поменять вручную во время игры, но во время тестирования её можно переопределить в настройках ct.js через опцию "Включить релизные функции для дебаг-экспортов".
