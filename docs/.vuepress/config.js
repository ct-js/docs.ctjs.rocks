  ...
  themeConfig: {
    ...
    sidebar: [
      ["/", "Home"],
      {
        ...
        collapsable: false,
        children: ["jsintro_pt1", "jsintro_pt2"],
      },
      {
        collapsable: false,
        title: "Tutorials",
      ...
      },
      {
        ...
        children: ["building-your-game", "deployment-itch-io"],
      },
      {
      ...
      },
      {
        ...
        children: [
          ...
          [
            "modding-typings-and-intellisense",
      ...
      },
      {
        ...
        children: [
          ...
          [
            "troubleshooting-teared-background",
            "Background splits into squares!",
          ],
          ["troubleshooting-leaking-pixels", "Textures have leaked pixels!"],
          [
            "troubleshooting-sounds-not-playing",
            "Sounds don't play at game start!",
          ],
        ],
      },
    ],
      ...
      "/pt_BR/": {
        ...
        sidebar: [
          ...
          ["pt_BR/", "Página Inicial"],
          {
            ...
            collapsable: false,
            children: ["pt_BR/jsintro_pt1", "pt_BR/jsintro_pt2"],
          },
          {
            collapsable: false,
            title: "Tutoriais",
          ...
          },
          {
            ...
            children: [
              ...
              [
                "pt_BR/catmoddocs",
                "Onde está a documentação para os outros módulos ct.*?",
              ],
            ],
          },
          {
          ...
          },
          {
            ...
            collapsable: false,
            children: [["pt_BR/making-mods", "Criando os seus próprios mods"]],
          },
          {
            ...
            children: [
              ...
              [
                "pt_BR/troubleshooting-teared-background",
                "Minha imagem de fundo dividida em quadrados!",
              ],
              [
                "pt_BR/troubleshooting-sounds-not-playing",
                "Som não toca no início do jogo!",
              ],
            ],
          },
        ],
