...
::: tip Ehi,
Questo tutorial presuppone che tu abbia terminato il tutorial [Making Games: Jetty Cat](https://docs.ctjs.rocks/tut-making-jettycat.html) . Dovresti completare questo prima.
:::
...
![Importa una texture dalla galleria](./images/tutJettyCat_gallery.png)
